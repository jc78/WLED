...
class PresetButtonsUsermod : public Usermod {
  ...
  public:
    ...
    bool readFromConfig(JsonObject& root)
    {
      ...
      configComplete &= getJsonValue(top["Button1Pin"], pin1);
      configComplete &= getJsonValue(top["Button2Pin"], pin2);
      configComplete &= getJsonValue(top["Button3Pin"], pin3);
      configComplete &= getJsonValue(top["Button4Pin"], pin4);
...
const char PresetButtonsUsermod::_name[]    PROGMEM = "PresetButtons";
const char PresetButtonsUsermod::_enabled[] PROGMEM = "enabled";


// implementation of non-inline member methods

void PresetButtonsUsermod::publishMqtt(const char* state, bool retain)
{
#ifndef WLED_DISABLE_MQTT
