...
enum struct PinOwner : uint8_t {
  ...
  UM_StatusPixel       = USERMOD_ID_STATUS_PIXEL,       // 0x27 // Usermod "usermod_v2_status_pixel.h"
  UM_PresetButtons     = USERMOD_ID_PRESET_BUTTONS      // 0x28 // Usermod "usermod_v2_preset_buttons.h"
};
